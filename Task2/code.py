...
def simulation_values(Kp,Ki,Kd,duration=500,dt=0.1):
    ...
    for i in range(steps):
        ...
        pv=2+0.01*time_arr[i]+0.05*control_output
...
ax2.set_title(" Pump flow rate vs time")
...
slider_Kp=Slider(ax1_Kp,'Kp proportional',0.0,20.0, valinit=initial_Kp,valstep=0.1)
